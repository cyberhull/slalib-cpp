...
/**
 * Converts equatorial to horizon coordinates: HA,Dec to Az,El (single precision).
 *
 ...
 * would require the "topocentric" HA,Dec. If the effects of diurnal aberration can be neglected, the "apparent"
