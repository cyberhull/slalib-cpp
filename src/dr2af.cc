...
/**
 * Converts an angle in radians into degrees, arcminutes, arcseconds (double precision).
 *
...
void dr2af(int ndp, double angle, ConversionResult& result) {
    ...
    constexpr double factor = 15.0 / 6.283185307179586476925287;
    dd2tf(ndp, angle * factor, result);
}
